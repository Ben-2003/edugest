...
@section('page-title', 'Modifier Parent')
@section('breadcrumb', 'Parents > Modifier')
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.parents.update', $parent) }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="first_name" class="form-control" value="{{ old('first_name', $parent->user->first_name) }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Nom</label>
                        <div class="col-sm-9">
                            <input type="text" name="last_name" class="form-control" value="{{ old('last_name', $parent->user->last_name) }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Email</label>
                        <div class="col-sm-9">
                            <input type="email" name="email" class="form-control" value="{{ old('email', $parent->user->email) }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
