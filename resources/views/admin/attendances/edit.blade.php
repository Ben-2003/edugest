...
@section('page-title', 'Modifier Presence')
@section('breadcrumb', 'Absences > Modifier')
...
<div class="row">
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    <i class="mdi mdi-calendar-edit text-warning me-2"></i> Modifier la presence
                ...
                <form action="{{ route('admin.attendances.update', $attendance) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        {{-- Eleve -- pre-rempli avec l'eleve actuel --}}
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="reason" class="form-control" rows="3"
                                    placeholder="Raison de l'absence ou observation...">{{ old('reason', $attendance->reason) }}</textarea>
                            </div>
                        </div>
    ...
    fetch(`/api/classes/${classId}/students`)
        ...
        .then(data => {
            ...
            data.forEach(student => {
                const selected = student.id == {{ $attendance->student_id }} ? 'selected' : '';
                studentSelect.innerHTML += `<option value="${student.id}" ${selected}>${student.last_name} ${student.first_name}</option>`;
            });
        })
        .catch(() => {
