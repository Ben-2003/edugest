        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">
                    ...
                    <small class="text-muted d-block mt-1" style="font-size:13px;">Remplissez les informations de la classe</small>
                </h4>
                <form action="{{ route('admin.classes.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="class_name" class="form-control" value="{{ old('class_name') }}" placeholder="Ex: CP-A" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Capacite maximale <span class="text-danger">*</span></label>
                                <input type="number" name="capacity" class="form-control" value="{{ old('capacity', 30) }}" min="1" max="100">
                    ...
                    <div class="text-right mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="mdi mdi-check"></i> Creer la classe
                        </button>
                    </div>
                </form>
            </div>
