...
<head>
    ...
    <title>EduGest — Ajouter un Élève</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; font-family:'DM Sans',sans-serif; }
        ...
        .logout-btn { display:flex; align-items:center; gap:10px; padding:10px 12px; border-radius:10px; color:var(--accent3); text-decoration:none; font-size:14px; font-weight:500; background:rgba(255,107,107,0.08); border:1px solid rgba(255,107,107,0.15); cursor:pointer; width:100%; }
        ...
        .btn-submit { display:flex; align-items:center; gap:8px; background:linear-gradient(135deg,var(--accent),#5a52d5); color:white; border:none; border-radius:10px; padding:11px 24px; font-size:14px; font-weight:600; cursor:pointer; text-decoration:none; transition:all 0.2s; }
...
<div class="main">
    <div class="topbar">
        <div>
            <div class="topbar-title">Ajouter un Élève</div>
