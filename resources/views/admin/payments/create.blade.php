...
<style>
    ...
    input:focus, select:focus, textarea:focus { border-color:var(--accent2); box-shadow:0 0 0 3px rgba(0,212,170,0.1); }
    ...
    .status-label:hover { border-color:var(--accent2); background:var(--surface2); }
...
<div class="form-card">
    <div class="form-header">
        ...
        <div>
            ...
            <div class="form-subtitle">Enregistrer un paiement de scolarité</div>
        </div>
    </div>
    <div class="form-body">
        <form action="{{ route('admin.payments.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="amount" value="{{ old('amount') }}"
                       min="0" step="500" placeholder="Ex: 50000">
            ...
            <div class="form-group">
                ...
                <textarea name="description" placeholder="Ex: Frais de scolarité Trimestre 1...">{{ old('description') }}</textarea>
            </div>
